...
version = None
with open(os.path.join(os.getcwd(), "{{cookiecutter.project_name}}",
                       "version.py")) as f:
  for l in f:
...
npm_package = "{{cookiecutter.project_name}}-{}.tgz".format(version)
...
setup(
    ...
    version=version,
    description="{{cookiecutter.settings_project_title}}",
